  ...
  constructor(props) {
    ...
    this.state = {
      settingList: [
        ...
        {
          id: 3,
          title: "Chúng tôi có thể cải \nthiện ứng dụng này như \nthế nào?",
        },
        { id: 4, title: "Chia sẻ ứng dụng" },
        {
          id: 5,
          text:
            "Thành thật xin lỗi nếu có những lỗi chính tả hoặc bản dịch sai xuất hiện trong ứng dụng này. Chúng tôi chỉ là một nhóm nhỏ nên dù đã và đang cố gắng hết sức để cải thiện dần ứng dụng nhưng vẫn không thể tránh khỏi sai sót. Nếu bạn phát hiện ra lỗi sai, xin hãy liên hệ với chúng tôi qua email: nhombay.appdev@gmail.com! \n\nSự ủng hộ của các bạn là động lực rất lớn đối với chúng tôi! Xin cảm ơn!",
